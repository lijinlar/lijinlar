...
- 🌐 [OpenVoice Agents](https://www.openvoiceagents.com/) - AI phone receptionist for your business
- 🖥️ [handsfree-windows](https://github.com/lijinlar/handsfree-windows) - Let the agent control your Windows desktop
- 📈 [etoro-cli](https://github.com/lijinlar/etoro-cli) - Let the agent trade on eToro via CLI
